...
# ✨ Enhanced with animations & Changelog
# 🟣 Customized by @AghaBanafshi
# Original: github.com/x4gking
...
<div class="wrap"><div class="card">
  ...
  <div class="footer">
    <div class="row">ساخته شده با ❤️ توسط <a href="https://github.com/x4gking" target="_blank">@x4gking</a></div>
...
<section class="pg on" id="pg-overview">
  ...
  <div class="dash-footer">
    ...
    <div style="display:flex;gap:6px;font-size:9px;color:var(--t3);align-items:center;flex-wrap:wrap">
      <span>❤️ <a href="https://github.com/x4gking" target="_blank" style="color:var(--accent)">@x4gking</a></span>
      <span>|</span>
